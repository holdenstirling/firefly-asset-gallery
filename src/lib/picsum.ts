 ...
 * @param options.seed - Stable image identifier; the same seed returns the
 * same image.
 * @param options.width - Requested image width in pixels.
 * @param options.height - Requested image height in pixels.
 * @param options.blur - Optional blur strength from 1 to 10. Values outside
 * that range are ignored.
 * @param options.grayscale - When true, requests a grayscale version of the
 * image.
 */
